...
<body>
	...
	<div id="content">
		...
		<div id="header"></div>
		<script>document.getElementById('header').innerHTML = "<h2>"+siteName+" {"+$id+"} and connected sites</h2>";</script>
		<div id="main">
			<div id="map"></div>
